...
[](https://github.com/amtzespinosa/kioptrix2-walkthrough/blob/main/README.md#ctf-4---kioptrix-11)
...
[](https://github.com/amtzespinosa/kioptrix2-walkthrough/blob/main/README.md#my-setup)
...
- A **local network** for both machines. If you want to know how to set up a local network for your VirtualBox adventures, follow 
...
So let's start with HTTP/S. We have both ports open. **Port 80 is for http and port 443 for https.** So the first thing we are going to do is open the browser and search for [http://192.168.1.38](http://192.168.1.38/) (in my case). We find a login page, let's keep going with the recon before trying anything here.

Visiting [http://192.168.1.38:3306/](http://192.168.1.38:3306/) we see we are not allowed to connect to the MySQL server.
